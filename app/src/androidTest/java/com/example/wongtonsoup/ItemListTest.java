...
public class ItemListTest{
    ...
    public void testUpdateData() {
        ...
        updatedItems.add(new Item("oxoxox", "01-01-2000", "Honda car", "Honda", "2016 CRV", f, "I like this car", "1234", "test_user", tagList));
        updatedItems.add(new Item("ooxxoo", "01-02-2000", "Chevy car", "chevrolet ", "Corvette", f2, "I really like this car", "1234", "test_user", tagList));
